...
class PaillierPublicKey(object):
    ...
    def encrypt(self, value, precision=None, random_value=None):
        ...
        """
        encoding = fixedpoint.FixedPointNumber.encode(value, self.n, self.max_int, precision)
...
class PaillierPrivateKey(object):
    ...
    def decrypt(self, encrypted_number):
        ...
        encoded = fixedpoint.FixedPointNumber(encoded,
...
class PaillierEncryptedNumber(object):
    ...
    def __mul__(self, scalar):
        ...
        encode = fixedpoint.FixedPointNumber.encode(scalar, self.public_key.n, self.public_key.max_int)
    ...
    def increase_exponent_to(self, new_exponent):
        ...
        factor = pow(fixedpoint.FixedPointNumber.BASE, new_exponent - self.exponent)
    ...
    def decrease_exponent_to(self, new_exponent):
        ...
        factor = pow(fixedpoint.FixedPointNumber.BASE, self.exponent - new_exponent)
        new_encryptednumber = self.__mul__(factor)
        new_encryptednumber.exponent = new_exponent
    ...
    def __add_scalar(self, scalar):
        ...
        """
        encoded = fixedpoint.FixedPointNumber.encode(scalar,
                                          self.public_key.n,
                                          self.public_key.max_int,
