...
class DataCompose():
  def __init__(self):
    ...
    self.train_set = torchvision.datasets.CIFAR10(root='../temp_codes/Lab_hp/data/cifar10', train=True, download=True, transform=train_augs)
    self.test_set = torchvision.datasets.CIFAR10(root='../temp_codes/Lab_hp/data/cifar10', train=False, download=True, transform=test_augs)
